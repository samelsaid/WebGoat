...
public class SqlInjectionLesson6a implements AssignmentEndpoint {
  ...
  public AttackResult injectableQuery(String accountName) {
    // The last name is bound instead of concatenated, so a UNION (or anything else) sent in the
    // parameter is matched as a literal name rather than parsed as SQL.
